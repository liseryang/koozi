 ...
 * @since 3.0
 * @see <a href="http://tools.ietf.org/html/rfc2616#section-3.7">HTTP 1.1,
 *      section 3.7</a>
 */
public class MediaType implements Comparable<MediaType> {
	...
	/**
	 * Create a new {@link MediaType} for the given type, subtype, and quality
	 * value.
	 * 
	 * @param type
	 *            the primary type
	 ...
	 * {@link MediaType}, and allows for different parameter.
	 * 
	 * @param other
	 ...
	 * @see <a href="http://tools.ietf.org/html/rfc2616#section-2.2">HTTP 1.1,
	 *      section 2.2</a>
	 */
	...
	public double getQualityValue() {
		...
		return (qualityFactory != null ? Double.parseDouble(qualityFactory) : .5D);
	}
	 ...
	 * <p>
	 * For instance, {@code text/*} includes {@code text/plain}, {@code
	 * text/html}, and {@code application/*+xml} includes {@code
	 * application/soap+xml}, etc. This method is non-symmetic.
	 * 
	 * @param other
	...
	/**
	 * Indicate whether this {@link MediaType} is compatible with the given
	 * media type.
	 * <p>
	 * For instance, {@code text/*} is compatible with {@code text/plain},
	 * {@code text/html}, and vice versa. In effect, this method is similar to
	 * {@link #includes(MediaType)}, except that it's symmetric.
	 * 
	 * @param other
	 *            the reference media type with which to compare
	 * @return <code>true</code> if this media type is compatible with the given
	 *         media type; <code>false</code> otherwise
	 */
	public boolean isCompatibleWith(MediaType other) {
		...
		if (isWildcardType() || other.isWildcardType()) {
			...
			// application/*+xml is compatible with application/soap+xml, and
			// vice-versa
			int thisPlusIdx = this.subtype.indexOf('+');
			int otherPlusIdx = other.subtype.indexOf('+');
			if (thisPlusIdx != -1 && otherPlusIdx != -1) {
	...
	/**
	 * Parse the given String value into a {@link MediaType} object, with this
	 ...
	 * @see <a href="http://tools.ietf.org/html/rfc2616#section-14.1">HTTP 1.1,
	 *      section 14.1</a>
	 */
