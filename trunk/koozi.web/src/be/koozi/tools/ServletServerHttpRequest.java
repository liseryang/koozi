...
public class ServletServerHttpRequest implements ServerHttpRequest {
	...
	public URI getURI() {
		try {
			return new URI(servletRequest.getScheme(), null, servletRequest.getServerName(), servletRequest.getServerPort(), servletRequest.getRequestURI(), servletRequest.getQueryString(), null);
