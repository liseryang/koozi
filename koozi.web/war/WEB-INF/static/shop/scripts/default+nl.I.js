(function() {
var _UDS_CONST_LOCALE = 'nl';
var _UDS_CONST_SHORT_DATE_PATTERN = 'DMY'; 
var _UDS_MSG_SEARCHER_IMAGE = ('Afbeelding'); 
var _UDS_MSG_SEARCHER_WEB = ('Web'); 
var _UDS_MSG_SEARCHER_BLOG = ('Blog'); 
var _UDS_MSG_SEARCHER_VIDEO = ('Video'); 
var _UDS_MSG_SEARCHER_LOCAL = ('Lokaal'); 
var _UDS_MSG_SEARCHCONTROL_SAVE = ('opslaan'); 
var _UDS_MSG_SEARCHCONTROL_KEEP = ('bewaren'); 
var _UDS_MSG_SEARCHCONTROL_INCLUDE = ('insluiten'); 
var _UDS_MSG_SEARCHCONTROL_COPY = ('kopi\u00ebren'); 
var _UDS_MSG_SEARCHCONTROL_CLOSE = ('sluiten'); 
var _UDS_MSG_SEARCHCONTROL_SPONSORED_LINKS = ('Gesponsorde koppelingen'); 
var _UDS_MSG_SEARCHCONTROL_SEE_MORE = ('meer weergeven\u2026'); 
var _UDS_MSG_SEARCHCONTROL_WATERMARK = ('geknipt van Google'); 
var _UDS_MSG_SEARCHER_CONFIG_SET_LOCATION = ('Locatie zoeken'); 
var _UDS_MSG_SEARCHER_CONFIG_DISABLE_ADDRESS_LOOKUP = ('Opzoeken van adressen uitschakelen'); 
var _UDS_MSG_SEARCHER_NEWS = ('Nieuws'); 
function _UDS_MSG_MINUTES_AGO(AGE_MINUTES_AGO) {return ('' + AGE_MINUTES_AGO + ' minuten geleden');} 
var _UDS_MSG_ONE_HOUR_AGO = ('1 uur geleden'); 
function _UDS_MSG_HOURS_AGO(AGE_HOURS_AGO) {return ('' + AGE_HOURS_AGO + ' uur geleden');} 
function _UDS_MSG_NEWS_ALL_N_RELATED(NUMBER) {return ('alle ' + NUMBER + ' soortgelijke');} 
var _UDS_MSG_NEWS_RELATED = ('Verwante artikelen'); 
var _UDS_MSG_BRANDING_STRING = ('mogelijk gemaakt door Google'); 
var _UDS_MSG_SORT_BY_DATE = ('Sorteren op datum'); 
var _UDS_MSG_MONTH_ABBR_JAN = ('Jan'); 
var _UDS_MSG_MONTH_ABBR_FEB = ('Feb'); 
var _UDS_MSG_MONTH_ABBR_MAR = ('Mrt'); 
var _UDS_MSG_MONTH_ABBR_APR = ('Apr'); 
var _UDS_MSG_MONTH_ABBR_MAY = ('Mei'); 
...
var _UDS_MSG_MONTH_ABBR_OCT = ('Okt'); 
var _UDS_MSG_MONTH_ABBR_NOV = ('Nov'); 
var _UDS_MSG_MONTH_ABBR_DEC = ('Dec'); 
var _UDS_MSG_DIRECTIONS = ('routebeschrijving'); 
var _UDS_MSG_CLEAR_RESULTS = ('resultaten wissen'); 
var _UDS_MSG_SHOW_ONE_RESULT = ('\u00e9\u00e9n resultaat weergeven'); 
var _UDS_MSG_SHOW_MORE_RESULTS = ('meer resultaten weergeven'); 
var _UDS_MSG_SHOW_ALL_RESULTS = ('alle resultaten weergeven'); 
var _UDS_MSG_SETTINGS = ('instellingen'); 
var _UDS_MSG_SEARCH = ('zoeken'); 
var _UDS_MSG_SEARCH_UC = ('Zoeken'); 
var _UDS_MSG_POWERED_BY = ('mogelijk gemaakt door'); 
function _UDS_MSG_LOCAL_ATTRIBUTION(LOCAL_RESULTS_PROVIDER) {return ('Bedrijfsvermeldingen verstrekt door ' + LOCAL_RESULTS_PROVIDER);} 
var _UDS_MSG_SEARCHER_BOOK = ('Boek zoeken'); 
function _UDS_MSG_FOUND_ON_PAGE(FOUND_ON_PAGE) {return ('Pagina ' + FOUND_ON_PAGE);} 
function _UDS_MSG_TOTAL_PAGE_COUNT(PAGE_COUNT) {return ('' + PAGE_COUNT + ' pagina\047s');} 
var _UDS_MSG_SEARCHER_BY = ('door'); 
var _UDS_MSG_SEARCHER_CODE = ('Code'); 
var _UDS_MSG_UNKNOWN_LICENSE = ('Onbekende licentie'); 
var _UDS_MSG_SEARCHER_GSA = ('Search Appliance'); 
var _UDS_MSG_SEARCHCONTROL_MORERESULTS = ('Meer resultaten'); 
var _UDS_MSG_SEARCHCONTROL_PREVIOUS = ('Vorige'); 
var _UDS_MSG_SEARCHCONTROL_NEXT = ('Volgende'); 
var _UDS_MSG_GET_DIRECTIONS = ('Routebeschrijving'); 
var _UDS_MSG_GET_DIRECTIONS_TO_HERE = ('Naar:'); 
var _UDS_MSG_GET_DIRECTIONS_FROM_HERE = ('Van:'); 
var _UDS_MSG_CLEAR_RESULTS_UC = ('Resultaten wissen'); 
var _UDS_MSG_SEARCH_THE_MAP = ('kaart doorzoeken'); 
var _UDS_MSG_SCROLL_THROUGH_RESULTS = ('bladeren door resultaten'); 
var _UDS_MSG_EDIT_TAGS = ('labels bewerken'); 
var _UDS_MSG_TAG_THIS_SEARCH = ('deze zoekopdracht labelen'); 
var _UDS_MSG_SEARCH_STRING = ('zoekreeks'); 
var _UDS_MSG_OPTIONAL_LABEL = ('optioneel label'); 
var _UDS_MSG_DELETE = ('verwijderen'); 
var _UDS_MSG_DELETED = ('verwijderd'); 
var _UDS_MSG_CANCEL = ('annuleren'); 
var _UDS_MSG_UPLOAD_YOUR_VIDEOS = ('uw eigen video uploaden'); 
var _UDS_MSG_IM_DONE_WATCHING = ('Ik ben uitgekeken.'); 
var _UDS_MSG_CLOSE_VIDEO_PLAYER = ('videospeler sluiten'); 
var _UDS_MSG_NO_RESULTS = ('Geen resultaten'); 
var _UDS_MSG_LINKEDCSE_ERROR_RESULTS = ('Deze aangepaste zoekmachine wordt geladen. Probeer het over enkele seconden nogmaals.'); 
var _UDS_MSG_COUPONS = ('Kortingsbonnen'); 
var _UDS_MSG_BACK = ('vorige'); 
var _UDS_MSG_SUBSCRIBE = ('Aanmelden'); 
var _UDS_MSG_SEARCHER_PATENT = ('Patent'); 
var _UDS_MSG_USPAT = ('US Pat.'); 
var _UDS_MSG_USPAT_APP = ('US Pat. App'); 
var _UDS_MSG_PATENT_FILED = ('Opgeslagen'); 
var _UDS_MSG_ADS_BY_GOOGLE = ('Ads door Google'); 
var _UDS_MSG_SET_DEFAULT_LOCATION = ('Standaardlocatie instellen'); 
var _UDS_MSG_NEWSCAT_TOPSTORIES = ('Voorpaginanieuws'); 
var _UDS_MSG_NEWSCAT_WORLD = ('Buitenland'); 
var _UDS_MSG_NEWSCAT_NATION = ('Binnenland'); 
var _UDS_MSG_NEWSCAT_BUSINESS = ('Economie'); 
var _UDS_MSG_NEWSCAT_SCITECH = ('Wetenschap/techniek'); 
var _UDS_MSG_NEWSCAT_ENTERTAINMENT = ('Entertainment'); 
var _UDS_MSG_NEWSCAT_HEALTH = ('Gezondheid'); 
var _UDS_MSG_NEWSCAT_SPORTS = ('Sport'); 
var _UDS_MSG_NEWSCAT_POLITICS = ('Politiek');
