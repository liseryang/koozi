...
<#if isCurrentuser??>
	<@include_page path="${base}/users/currentuser/roles" inherit_params=true params={"view": "edit", "bar": ["a", "b"]}/>
<#else>
	<@include_page path="${base}/users/${user.userId}/roles" inherit_params=true params={"view": "edit", "bar": ["a", "b"]}/>
</#if>
