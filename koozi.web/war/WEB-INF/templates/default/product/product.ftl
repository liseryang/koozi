...
<h3>Pricing</h3>
<@include_page path="${base}/products/${product.id}/prices" inherit_params=true  params={"view": "embedded"}/>
<form action="${base}/products/${product.id}/prices	" method="get">
	<input type="submit"  value="Edit product pricing"/>
	<input type="hidden" name="view" value="edit"/>
</form>
<h3>Pictures</h3>
...
<h3>Options</h3>
<@include_page path="${base}/products/${product.id}/options" inherit_params=true  params={"view": "embedded"}/>
<form action="${base}/products/${product.id}/options" method="get">
	<input type="submit"  value="Edit product options"/>
	<input type="hidden" name="view" value="edit"/>
</form>